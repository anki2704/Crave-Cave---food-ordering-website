...
<html>
  ...
  <head>
    <title> Manager Login | crave cave</title>
  </head>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "SELECT * FROM food f WHERE f.R_ID IN (SELECT r.R_ID FROM restaurant r WHERE r.M_ID='$user_check') ORDER BY F_ID");
