...
<body>
        ...
        ?>
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart
                (<?php echo isset($_SESSION["cart"]) ? count($_SESSION["cart"]) : "0"; ?>)</a></li>
  ...
  if (isset($_SESSION["cart"]) && is_array($_SESSION["cart"])) {
    foreach ($_SESSION["cart"] as $keys => $values) {
      $gtotal += ($values["food_quantity"] * $values["food_price"]);
    }
  }
  ?>
  ...
  <h1 class="text-center">
    ...
    <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-shopping-cart"></span> Cash On Delivery</button></a>
  </h1>
